...
const ReceiptsController = Nodal.require('app/controllers/receipts_controller.js');
const AuthsController = Nodal.require('app/controllers/auths_controller.js');
...
router.route('/auths/{id}').use(AuthsController);
router.route('/receipts/{id}').use(ReceiptsController);
